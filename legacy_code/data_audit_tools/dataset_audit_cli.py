...
Usage examples:
    python dataset_audit_cli.py scan --root . --output dataset_metadata.json
    python dataset_audit_cli.py centroids --seg path/to/segmentation.nii.gz --output centroids.json
    python dataset_audit_cli.py batch-centroids --metadata dataset_metadata.json --output centroids_batch.json
"""
...
CONFIG = {
    ...
    "output_dir": r"C:\Users\<USER>\Desktop\BENG 280C Project\Optimal-LV-Placement-ML\data_audit_tools/output",  # Directory to save JSON files
