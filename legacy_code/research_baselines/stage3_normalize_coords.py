...
Usage:
    python stage3_normalize_coords.py
...
CENTROIDS_JSON   = Path(r"C:\Users\<USER>\Desktop\BENG 280C Project\Optimal-LV-Placement-ML\research_baselines\centroids_results.json")
OUTPUT_JSON      = Path(r"C:\Users\<USER>\Desktop\BENG 280C Project\Optimal-LV-Placement-ML\research_baselines\normalized_results.json")
OUTPUT_REPORT    = Path(r"C:\Users\<USER>\Desktop\BENG 280C Project\Optimal-LV-Placement-ML\research_baselines\normalized_report.txt")
