Based on everything we discovered and debugged together, here is a **revised, production‑ready project prompt** that incorporates all the hard‑won lessons. If you were to start fresh, this is the specification you would use as the implementation roadmap.
