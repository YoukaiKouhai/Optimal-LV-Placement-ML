...
Usage:
    python stage8b_mip_cnn_roi.py
    python stage8b_mip_cnn_roi.py --auto-tune              # VRAM probe + grid → mip_tune_best.json
    python stage8b_mip_cnn_roi.py --auto-tune-apply        # tune then full run with best config
    python stage8b_mip_cnn_roi.py --config mip_tune_best.json
    python stage8b_mip_cnn_roi.py --no-dual --no-tta --no-roi
"""
...
BASE_DIR       = Path(r"C:\Users\<USER>\Desktop\BENG 280C Project\Optimal-LV-Placement-ML\research_baselines")
