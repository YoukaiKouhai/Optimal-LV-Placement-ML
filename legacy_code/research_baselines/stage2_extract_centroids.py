...
Usage:
    python stage2_extract_centroids.py
"""
...
INVENTORY_JSON  = Path(r"C:\Users\<USER>\Desktop\BENG 280C Project\Optimal-LV-Placement-ML\research_baselines\data_inventory.json")
OUTPUT_JSON     = Path(r"C:\Users\<USER>\Desktop\BENG 280C Project\Optimal-LV-Placement-ML\research_baselines\centroids_results.json")
OUTPUT_REPORT   = Path(r"C:\Users\<USER>\Desktop\BENG 280C Project\Optimal-LV-Placement-ML\research_baselines\centroids_report.txt")
